...
INSERT INTO "new_Order" ("cardInfoId", "createdAt", "id", "orderNumber", "shippingCost", "shippingInfoId", "shippingMethod", "status", "totalPrice", "updatedAt", "userId") SELECT "cardInfoId", "createdAt", "id", "orderNumber", "shippingCost", "shippingInfoId", "shippingMethod", "status", "totalPrice", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
